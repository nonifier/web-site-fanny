...
var _bulmaCarousel = require('../node_modules/bulma-carousel/dist/js/bulma-carousel.js');
...
var carousels = _bulmaCarousel2.default.attach('.carousel', options);
...
function closeModal() {
    (0, _jquery2.default)('div.is-active').removeClass('is-active');
}

(0, _jquery2.default)('#item-1-button').click(function () {
    (0, _jquery2.default)('#item-1-modal').addClass('is-active');
});
(0, _jquery2.default)('#item-2-button').click(function () {
    (0, _jquery2.default)('#item-2-modal').addClass('is-active');
});
(0, _jquery2.default)('#item-3-button').click(function () {
    (0, _jquery2.default)('#item-3-modal').addClass('is-active');
});
(0, _jquery2.default)('#item-4-button').click(function () {
    (0, _jquery2.default)('#item-4-modal').addClass('is-active');
});
(0, _jquery2.default)('#item-5-button').click(function () {
    (0, _jquery2.default)('#item-5-modal').addClass('is-active');
});
(0, _jquery2.default)('#item-6-button').click(function () {
    (0, _jquery2.default)('#item-6-modal').addClass('is-active');
});
(0, _jquery2.default)('#item-7-button').click(function () {
    (0, _jquery2.default)('#item-7-modal').addClass('is-active');
});
(0, _jquery2.default)('.modal-background, button.modal-close').click(closeModal);

},{"../node_modules/bulma-carousel/dist/js/bulma-carousel.js":2,"jquery":3}],2:[function(require,module,exports){
